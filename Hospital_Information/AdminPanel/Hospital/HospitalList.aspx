...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    ...
    <li class="breadcrumb-item active" aria-current="page">Hosptial List
    </li>
</asp:Content>
    ...
    <div class="row">
        <div class="col-md-12 mt-4">
            <div class="card border-0 p-4 rounded shadow">
                <div id="divHospitalAddButton" runat="server" class="text-end border-bottom" style="padding: 0px 20px 10px 0px">
            ...
            <div class="p-4 table-responsive ">
                ...
                <asp:GridView ID="gvHospital" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered" OnRowCommand="gvHospital_RowCommand" OnRowDataBound="gvHospital_RowDataBound">
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Actions">
                            <ItemTemplate>
                                <asp:HyperLink ID="hlHospitalDetail" runat="server" CssClass="btn btn-pills btn-outline-primary" NavigateUrl='<%# "~/AdminPanel/Hospital/HospitalDetail.aspx?HospitalID=" + Eval("HospitalID").ToString() %>'><i class="uil uil-eye"></i></asp:HyperLink>
